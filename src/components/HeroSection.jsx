...
const HeroSection = () => {
  return (
    <div className="container d-md-flex flex-wrap gap-lg-4 gap-3">
      {/* Hero Text  */}
      ...
      {/* Service Banner  */}
      <div className="col-md-4 bg-hero-service-banner mobile-class p-4 position-relative">
      ...
      {/* Cards  */}
      <div className="col-md-7 col-6 px-2 px-md-0 text-md-end">
      ...
      <div className="col-md-4 col-6 px-2 px-md-0 bg-banner-card text-black">
        <div className=" py-4">
